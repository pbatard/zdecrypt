zdecrypt: An application to decrypt `_encryp1_` Zyxel fields
============================================================

[![Build status](https://img.shields.io/github/actions/workflow/status/pbatard/zdecrypt/vs2026.yml?style=flat-square)](https://github.com/pbatard/zdecrypt/actions/workflows/vs2026.yml)
[![Build status](https://img.shields.io/github/actions/workflow/status/pbatard/zdecrypt/linux.yml?style=flat-square)](https://github.com/pbatard/zdecrypt/actions/workflows/linux.yml)
...
7. Using SCP (SFTP or FTP probably won't work but SCP should) or copy to USB, if your device
   has a USB port, find a way to extract the content of the `tmp/dump/` from your device.
8. Zip that content (using 7-zip or some other utility) and e-mail it to `pete@akeo.ie` so
   I can take a look and try to figure out the key derivation for your device...
